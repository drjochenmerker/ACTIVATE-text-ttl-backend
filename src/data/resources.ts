...
export const supportedLLMs: LLM[] = [
    ...
    // },
    // Routes to 4.1-mini
    // 4.1-mini not better than 4.1
    {
        id: 'model-router',
        name: 'Azure Model Router (4.1-mini)',
        endpoint: 'azure',
        description: {
    ...
    // Generates TTL but very low quality and Syntax broken
    // {
    ...
    //     },
    // },
    // Scrapped because it fails a lot
    // {
